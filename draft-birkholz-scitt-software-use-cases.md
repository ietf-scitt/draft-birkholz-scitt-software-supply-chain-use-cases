...
Authentication takes place, for example, by checking an accompanying signature or by creating a hash of measurements and comparing them to a reference value.
Corresponding procedures are often called authenticated, measured, or secure boot. The output of these high assurance boot procedures is often used as input to more complex remote attestation procedures.
